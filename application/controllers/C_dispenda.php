...
class C_dispenda extends CI_Controller
{
    ...
    public function prosestambah()
    {
        ...
        if (!$this->upload->do_upload('foto')) {
            ...
            redirect(base_url() . 'dispenda/wajibpajak');
        }
    }
    ...
    public function prosesubah()
    {
        ...
        if (!$this->upload->do_upload('foto')) {
            ...
            redirect('dispenda/wajibpajakubah/' . $id_wp);
        } else {
            $foto = $this->upload->data();
    ...
    public function prosestambah_npa()
    {
        ...
        redirect('dispenda/nilaiperolehanair');
    }
    ...
    public function tagihan()
    {
        ...
        $this->load->view('dispenda/wajibpajak/tagihan');
    ...
    public function cetaktagihan()
    {
        ...
        $this->load->view('dispenda/partials/header_cetak');
        $this->load->view('dispenda/wajibpajak/cetaktagihan');
        $this->load->view('dispenda/partials/footer_cetak');
    }
}
