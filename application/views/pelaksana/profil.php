                                                                ...
                                                                <form action="">
                                                                    ...
                                                                    <div class="modal-body">
                                                                            ...
                                                                            <div class="form-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-lg" id="email" placeholder="Email" value="petugaslapangan@jayapurakota.go.id">
                                                                                <div class="valid-feedback">
                                                                                    Looks good!
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-lg" id="username" placeholder="Email" value="petugaslapangan">
                                                                                <div class="valid-feedback">
                                                                                    Looks good!
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group mb-3">
                                                                                ...
                                                                                <input type="text" class="form-control form-control-lg bg-soft-secondary" id="level" placeholder="Email" value="Petugas Lapangan" disabled>
                                                                            </div>
                                                ...
                                                <ul class="list-group">
                                                    ...
                                                    <li class="list-group-item list-group-item-lg">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-10">
                                                                petugaslapangan@jayapurakota.go.id
                                                            </div>
                                                        </div>
                                                    </li>
