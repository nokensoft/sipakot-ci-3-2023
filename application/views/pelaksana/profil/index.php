                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <a href="<?=base_url('pelaksana/profil/ubah')?>" data-plugin="tippy" data-tippy-placement="top-start" title="Menampilkan Halaman Ubah Profil">
                                                    ...
                                                    <li class="list-group-item list-group-item-lg">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8 col-md-12 col-sm-12 col-sx-12">
                                                                ...
                                                                <br>
                                                                <a href="<?=base_url('pelaksana/profil/ubah/foto')?>" class="btn btn-sm btn-dark mt-2 p-0 px-1" data-plugin="tippy" data-tippy-placement="top-start" title="Menampilkan Halaman Ubah Foto">Ubah Foto</a>
                                                            </div>
                                                        </div>
                                                    </li>
