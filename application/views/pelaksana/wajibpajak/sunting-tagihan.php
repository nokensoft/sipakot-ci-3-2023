                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <?= form_open_multipart('C_Tagihan/proses_ubah_tagihan'); ?>
                            ...
                            <input type="hidden" name="role" value="<?=$this->uri->segment(1)?>"> <!-- role -->
                            <input type="hidden" name="kategori_usaha" value="<?=$wajib_pajak['usaha_kategori']?>"> 
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="<?= base_url('pelaksana/wajibpajak/tagihan/new/') ?><?=$this->uri->segment(5)?>?t=<?=$_GET['t']?>" data-plugin="tippy" data-tippy-placement="top-start" title="Kembali ke Halaman Wajib Pajak">
