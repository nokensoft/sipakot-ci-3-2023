                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="<?= base_url('pelaksana/wajibpajak/tagihan/new/') ?><?=$this->uri->segment(5)?>?t=<?=$tagihan['tahun']?>" data-plugin="tippy" data-tippy-placement="top-start" title="Kembali ke Halaman Tagihan">
