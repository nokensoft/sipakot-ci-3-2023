                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('pelaksana/tagihan') ?>">Tagihan</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <a href="<?= base_url('pelaksana/wajibpajak/tagihan/new/') ?><?=$this->uri->segment(5)?>?t=<?=$_GET['t']?>" data-plugin="tippy" data-tippy-placement="top-start" title="Kembali ke Halaman Tagihan">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="kualitas">Komponen Sumber Daya Alam (SDA)</label>
