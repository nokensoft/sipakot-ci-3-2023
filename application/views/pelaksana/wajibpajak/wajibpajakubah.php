                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <?php foreach ($wp as $w) { ?>
                                    <form class="needs-validation " action="<?php echo base_url('C_petugaslapangan/prosesubah'); ?>" method="POST" novalidate="" enctype="multipart/form-data">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <h4 class="header-title">Form Ubah Wajib Pajak</h4>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="nama_usaha" class="form-control form-control-lg" id="validationCustom01" placeholder="First name" value="<?php echo $w->nama_usaha ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="nama_pemilik" class="form-control form-control-lg" id="validationCustom01" placeholder="First name" value="<?php echo $w->nama_pemilik ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="file" name="foto" class="form-control-file form-control-file-lg" id="validationCustom01" placeholder="First name" value="<?php echo $w->foto ?>">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="10" id="message" class="form-control form-control-lg" name="alamat" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 character comment.." data-parsley-validation-threshold="10" data-parsley-id="23"><?php echo $w->alamat ?></textarea>
                                                        </div>

                                                        <div class="form-group mb-3">
                                                            <label for="validationCustom01">No Telepon</label>
                                                            <input type="text" name="no_tlp" class="form-control form-control-lg" id="validationCustom01" placeholder="First name" value="<?php echo $w->no_tlp ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="email" class="form-control form-control-lg" id="validationCustom01" placeholder="First name" value="<?php echo $w->email ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-control form-control-lg" id="example-select" name="kategori_usaha">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="luas_bangunan" class="form-control form-control-lg" id="validationCustom01" placeholder="Luas bangunan" value="<?php echo $w->luas_bangunan ?>" required="">
                                                            <div class=" valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="luas_lahan" class="form-control form-control-lg" id="validationCustom01" placeholder="Luas lahan" value="<?php echo $w->luas_lahan ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-control form-control-lg" id="example-select" name="izin">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <select class="form-control form-control-lg" id="example-select" name="dokumen">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="jumlah_kamar" class="form-control form-control-lg" id="validationCustom01" placeholder="" value="<?php echo $w->jumlah_kamar ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="jumlah_penghuni" class="form-control form-control-lg" id="validationCustom01" placeholder="" value="<?php echo $w->jumlah_penghuni ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" name="jumlah_kursi" class="form-control form-control-lg" id="validationCustom01" placeholder="" value="<?php echo $w->jumlah_kursi ?>" required="">
                                                            <div class="valid-feedback">
                                                                Looks good!
                                                            </div>
                                                        </div>
