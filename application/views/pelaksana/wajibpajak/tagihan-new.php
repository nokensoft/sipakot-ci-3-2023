                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?= base_url('pelaksana/wajibpajak') ?>">Wajib Pajak</a></li>
            ...
            <!-- end page title -->
                ...
                <div class="row">  
                    ...
                    <div class="col-lg-3 col-md-12">
                        <div class="card-box">
                            <?php require_once('partials/sidebar-profil.php'); ?>    
                        </div>
                    </div> <!-- end col -->
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div class="btn-group dropdown mb-2">
                                                ...
                                                <div class="dropdown-menu" style="">
                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/new/' . $wajib_pajak['id_wp']) ?>?t=2021">2021</a>
                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/new/' . $wajib_pajak['id_wp']) ?>?t=2020">2020</a>
                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/new/' . $wajib_pajak['id_wp']) ?>?t=2019">2019</a>
                                                    <!-- <div class="dropdown-divider"></div> -->
                                                    <!-- <a class="dropdown-item" href="<?= base_url('wajibpajak/tagihan') ?>?t=semua">Semua</a> -->
                                                </div>
                                            </div>
                                            <a href="<?= base_url('pelaksana/wajibpajak/tagihan/buat/') . $this->uri->segment(5) . '?t='.date('Y')  ?>">
                                            ...
                                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td>
                                                            <a class="btn btn-xs btn-primary bg-light text-primary" href="<?= base_url('pelaksana/wajibpajak/tagihan/fna/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Lihat Perhitungan Faktor Nilai Air (FNA)">Faktor Nilai Air</a>
                                                            <a class="btn btn-xs btn-primary" href="<?= base_url('pelaksana/wajibpajak/tagihan/info/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Lihat Informasi Tagihan"><i class="fas fa-info-circle"></i> Info Tagihan</a>
                                                            <a class="btn btn-xs btn-primary" href="<?= base_url('pelaksana/wajibpajak/tagihan/cetak/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Cetak Info Tagihan"><i class="fas fa-print"></i></a>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <!-- <a class="btn btn-xs btn-success" href="<?= base_url('pelaksana/wajibpajak/tagihan/sunting/') . $this->uri->segment(5) . '?id=' . $tagihan['id'] . '&b='.$tagihan['id_bulan'].'&t='.date('Y')?>" data-plugin="tippy" data-tippy-placement="top-start" title="Ubah"><i class="mdi mdi-pencil"></i></a> -->
                                                            <!-- <a class="btn btn-xs btn-light" href="#" data-toggle="modal" data-target="#MODAL-HAPUS-<?=$tagihan['id']?>" data-plugin="tippy" data-tippy-placement="top-start" title="Hapus"><i class="fas fa-trash"></i></a> -->
                                                        
                                                            <div class="btn-group mb-2 dropright">
                                                                <button type="button" class="btn btn-sm btn-success waves-effect waves-light dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                                ...
                                                                <div class="dropdown-menu" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(106px, 0px, 0px);" x-placement="bottom-start">
                                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/fna/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Lihat Perhitungan Faktor Nilai Air (FNA)"><i class="fas fa-info-circle"></i> Faktor Nilai Air</a>
                                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/info/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Lihat Informasi Tagihan"><i class="fas fa-info-circle"></i> Info Tagihan</a>
                                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/cetak/') . $this->uri->segment(5) .'?id=' .$tagihan['id'] ?>" target="_blank" data-plugin="tippy" data-tippy-placement="top-start" title="Cetak Info Tagihan"><i class="fas fa-print"></i> Cetak Info Tagihan</a>

                                                                    <?php if(!empty($tagihan['bukti_pembayaran'])){ ?>

                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#MODAL-TAMPILKAN-<?=$tagihan['id']?>" data-plugin="tippy" data-tippy-placement="top-start" title="Tampilkan Bukti Pembayaran"><i class="fas fa-file"></i> Bukti Pembayaran</a>

                                                                    <?php } else { ?>

                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="#" data-plugin="tippy" data-tippy-placement="top-start" title="Bukti Pembayaran Belum Diunggah"><i class="fas fa-times"></i> Bukti Pembayaran</a>

                                                                    <?php }?>

                                                                    <div class="dropdown-divider"></div>
                                                                    <a class="dropdown-item" href="<?= base_url('pelaksana/wajibpajak/tagihan/sunting/') . $this->uri->segment(5) . '?id=' . $tagihan['id'] . '&b='.$tagihan['id_bulan'].'&t='.date('Y')?>" data-plugin="tippy" data-tippy-placement="top-start" title="Ubah"><i class="fas fa-edit"></i> Ubah</a>
