    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            <div class="container-fluid">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <!-- item-->
                            <a href="<?= base_url('pelaksana/profil') ?>" class="dropdown-item notify-item">
                                <i class="fe-user"></i>
                                <span>Profil</span>
                            </a>
                            ...
                            <!-- item-->
                            <a href="<?= base_url('pelaksana/keluar') ?>" class="dropdown-item notify-item">
                ...
                <!-- LOGO -->
                <div class="logo-box">
                    <a href="<?= base_url() ?>pelaksana/dasbor" class="logo logo-dark text-center">
                        <span class="logo-sm">
                    ...
                    <a href="<?= base_url() ?>pelaksana/dasbor" class="logo logo-light text-center">
                        <span class="logo-sm">
                            <img src="<?= base_url() ?>assets/images/logo-kota-jayapura-500.png" alt="" height="50">
                        </span>
                        <span class="logo-lg">
                ...
                <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                    ...
                    <li class="dropdown d-none d-xl-block">
                        <a class="nav-link dropdown-toggle waves-effect waves-light" href="<?= base_url() ?>pelaksana/dasbor" role="button" aria-haspopup="false" aria-expanded="false">
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="<?= base_url('pelaksana/dasbor')?>">
                        ...
                        <li>
                            <a href="<?= base_url('pelaksana/wajibpajak/semua') ?>">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="sidebarTentangPajak">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="<?= base_url('pelaksana/tentangpajak/dasarpengenaanpajak') ?>">Dasar Pengenaan Pajak</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('pelaksana/tentangpajak/nilaiperolehanair') ?>">Nilai Perolehan Air (NPA)</a>
                                    </li>
                                    <li>
                                        <a href="<?= base_url('pelaksana/tentangpajak/penentuannpa') ?>">Penentuan NPA</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
