            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Pengguna Terhapus</span></h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="<?= base_url('admin/pengguna') ?>" data-plugin="tippy" data-tippy-placement="top-start" title="Menampilkan Pengguna">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($pengguna as $l) { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if($l['role_id'] != 0) : ?>
                                                                    <a href="#" class="btn btn-xs btn-success" data-plugin="tippy" data-tippy-placement="top-start" title="Kembalikan" data-toggle="modal" data-target="#kembalikanPengguna<?= $l['id']; ?>"><i class=" mdi mdi-replay"></i></a>
                                                                    <a href="#" class="btn btn-xs btn-light" data-plugin="tippy" data-tippy-placement="top-start" title="Hapus" title="Menghapus data" data-toggle="modal" data-target="#hapusPengguna<?= $l['id']; ?>"><i class="fas fa-trash"></i></a>
                                                                <?php else: endif; ?>
                                                            </td>
                                                        </tr>

                                                        <!--  Modal content for the modalHda example -->
                                                        <div class="modal fade" id="kembalikanPengguna<?= $l['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    <?= form_open_multipart('C_user/proses_kembalikan_pengguna'); ?>
                                                                    <input type="hidden" name="id" value="<?= $l['id']; ?>">
                                                                    
                                                                    <div class="modal-body">

                                                                        <h1>Hapus?</h1>
                                                                        <p>Data akan dikembalikan ke Halaman Daftar Pengguna</p>
                                                        ...
                                                        <div class="modal fade" id="hapusPengguna<?= $l['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                                                                    <?= form_open_multipart('C_user/proses_hapus_pengguna_permanen'); ?>
                                                                    <input type="hidden" name="id" value="<?= $l['id']; ?>">
