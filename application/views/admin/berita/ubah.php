        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form class="needs-validation" action="<?php echo base_url('C_Berita/prosesubahberita'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="title" id="title" value="<?= $berita['title'] ?>" required>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <?php if(!empty($berita['image'])) { ?> 
                                                <img src="<?= base_url() ?>assets/images/berita/<?= $berita['image'] ?>" alt="" class="img img-thumbnail img-fluid">
                                            <?php } else { ?>
                                                <img src="<?= base_url() ?>assets/images/berita/no-image.png" alt="" class="img img-thumbnail img-fluid">
                                            <?php }?>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="body" class="form-control form-control-lg" rows="30" id="editor" width="100%"><?= $berita['body'] ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="form-control form-control-lg" name="is_active" id="is_active" required>
                                                <option></option>
                                                <option <?php if($berita['is_active'] == '1') {echo 'selected'; } ?> value="1">Aktif</option>
                                                <option <?php if($berita['is_active'] == '0') {echo 'selected'; } ?> value="0">Tidak Aktif</option>
                                            </select>
