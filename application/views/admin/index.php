                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <span class="badge badge-primary">
                                            <i class="fas fa-laptop mr-1"></i>Aplikasi Perhitungan Pajak Air Tanah
                                        </span>
                                    </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-sm bg-success rounded">
                                                <i class="fe-bookmark avatar-title font-22 text-white"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark my-1"><span data-plugin="counterup">12,145</span></h3>
                                                <p class="text-muted mb-1 text-truncate">Wajib Pajak</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h2 class="text-uppercase">Non Niaga <span class="float-right">60%</span></h2>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="mt-3">
                                        <h2 class="text-uppercase">Niaga Kecil <span class="float-right">49%</span></h2>
                                        <div class="progress progress-sm m-0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-bookmark mb-1 text-truncate">Wajib Pajak</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h2 class="text-uppercase">Industri Kecil <span class="float-right">18%</span></h2>
                                        <div class="progress progress-sm m-0">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="mt-3">
                                        <h2 class="text-uppercase">Niaga Besar <span class="float-right">74%</span></h2>
                                        <div class="progress progress-sm m-0">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="mt-3">
                                        <h2 class="text-uppercase">Industri Besar <span class="float-right">74%</span></h2>
                                        <div class="progress progress-sm m-0">
                                            <div class="progress-bar bg-blue" role="progressbar" aria-valuenow="74" aria-valuemin="0" aria-valuemax="100" style="width: 74%">
                                                <span class="sr-only">74% Complete</span>
                                            </div>
                                        </div>
                                    </div>
