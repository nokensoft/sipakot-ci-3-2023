                            ...
                            <div class="col-lg-6 col-xl-6">
                                ...
                                <div class="card">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank" href="<?= base_url('admin/wajibpajak/detail/') ?><?= $wajib_pajak_baru['id_wp']; ?>" class="btn btn-success btn-xs waves-effect waves-light" data-plugin="tippy" data-tippy-placement="top-start" title="Detail"><i class="fas fa-eye"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php $no++; endforeach; ?>
                                            </tbody>
                                    ...
                                    <div class="card-footer">
                                        <a href="<?=base_url('admin/wajibpajak')?>" class="btn btn-secondary btn-xs text-light waves-effect waves-light" data-plugin="tippy" data-tippy-placement="top-start" title="Semua Wajib Pajak"><i class="fas fa-book-open"></i> Semua</a>
                                    </div>
                                </div>
                                        ...
                                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a target="_blank" href="<?= base_url('admin/wajibpajak/tagihan/new/') ?><?= $tagihan_baru['id_wp']; ?>?t=<?=date('Y')?>" class="btn btn-success btn-xs waves-effect waves-light" data-plugin="tippy" data-tippy-placement="top-start" title="Tagihan"><i class="mdi mdi-animation-outline"></i> </a>
                                                    </td>
                                                </tr>
                                                <?php $no++; endforeach; ?>
                                            </tbody>
