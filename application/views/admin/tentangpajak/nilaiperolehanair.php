                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Nilai Perolehan Air (NPA)</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Nilai Perolehan Air (NPA)</span></h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                        ...
                                        <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <?= form_open_multipart('C_Tentangpajak/prosesubah_info_npa'); ?>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea class="form-control" id="editor" name="isi"> <?php echo $pajak_npa['isi'] ?> </textarea>
                                                        </div>
