                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ubah Foto Usaha</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Ubah Foto Usaha</span></h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <?= form_open_multipart('C_Wajibpajak/proses_ubah_foto_usaha'); ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-grouptext-center">
                                                            <?php if(!empty($wp['usaha_logo'])) { ?> 
                                                                <img src="<?= base_url() ?>assets/images/usaha_logo/<?=$wp['usaha_logo'] ?>" alt="" class="img img-thumbnail" width="300px">
                                                            <?php } else { ?> 
