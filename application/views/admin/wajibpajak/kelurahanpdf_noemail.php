     ...
     <div>
            ...
            <?php $i=1; foreach($wajib_pajak_sortir_kelurahan as $pajak): ?>
                <tr>
                    ...
                    <?php
                        $queryVolumeAir = $this->db->query("SELECT volume, keterangan FROM tagihan WHERE id_wp = '".$pajak['id_wp']."' ORDER BY id DESC LIMIT 1" );
                        ...
                        if($rowVolumeAir == null)
                        {
                            ...
                            echo "<td>". volume_air($rowVolumeAir['volume'])."</td>";
                            echo "<td>". $rowVolumeAir['keterangan']."</td>";
                        }
                        ?>
