                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="btn-group">                                                            
                                                            ...
                                                            <div class="dropdown-menu ml-2" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 44px, 0px);" x-placement="bottom-start">
                                                                     ...
                                                                     <a target='_blank' class="dropdown-item" href="<?= base_url('admin/wajibpajak/pdfdistrik/'. $this->uri->segment(4)) ?>">PDF Biasa</a>
                                                                     <a target='_blank' class="dropdown-item" href="<?= base_url('admin/wajibpajak/pdfdistrik/'. $this->uri->segment(4)).'?pdf=noemail' ?> "> PDF tanpa email & ada keterangan </a>
