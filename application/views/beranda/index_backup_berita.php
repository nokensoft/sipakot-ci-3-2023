                                    ...
                                    <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner" role="listbox">
                                            <div class="carousel-item active">
                                                <img src="<?=base_url()?>assets/images/small/img-1.jpg" alt="..." class="d-block img-fluid">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h3 class="text-white">First slide label</h3>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                    <a href="#" class="btn btn-xs btn-primary"data-toggle="modal" data-target="#MODAL-BERITA-id" >Selengkapnya</a>
                                                </div>

                                                <!-- MODAL BERITA  -->
                                                <!-- Large modal -->
                                                <!--  Modal content for the Large example -->
                                                <div class="modal fade" id="MODAL-BERITA-id" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">

                                                        <div class="modal-content">
                                                            <div class="modal-header bg-light">
                                                                <h1><i class="fas fa-globe-asia"></i> Judul Berita atau Pengumuman di Sini</h1>
                                            ...
                                            <div class="carousel-item">
                                                <img src="<?=base_url()?>assets/images/small/img-3.jpg" alt="..." class="d-block img-fluid">
                                                <div class="carousel-caption d-none d-md-block">
                                                    <h3 class="text-white">Second slide label</h3>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                    <a href="#" class="btn btn-xs btn-primary"data-toggle="modal" data-target="#MODAL-BERITA-id2" >Selengkapnya</a>
                                                </div>

                                                <!-- MODAL BERITA  -->
                                                <!-- Large modal -->
                                                <!--  Modal content for the Large example -->
                                                <div class="modal fade" id="MODAL-BERITA-id2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="carousel-item">
                                                ...
                                                <div class="carousel-caption d-none d-md-block">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                    <a href="#" class="btn btn-xs btn-primary"data-toggle="modal" data-target="#MODAL-BERITA-id3" >Selengkapnya</a>
                                                </div>
                                                ...
                                                <!-- Large modal -->
                                                <!--  Modal content for the Large example -->
                                                <div class="modal fade" id="MODAL-BERITA-id3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg">
