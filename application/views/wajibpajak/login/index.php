...
<head>
    ...
    <link href="<?= base_url() ?>assets/css/app-modern.min.css" rel="stylesheet" type="text/css" id="app-default-stylesheet" />

    <link href="<?= base_url() ?>assets/css/bootstrap-modern-dark.min.css" rel="stylesheet" type="text/css" id="bs-dark-stylesheet" />
    <link href="<?= base_url() ?>assets/css/app-modern-dark.min.css" rel="stylesheet" type="text/css" id="app-dark-stylesheet" />
                            ...
                            <form method="POST" action="<?= base_url('Loginwajibpajak') ?>">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="kata_sandi" class="form-control form-control-lg" placeholder="Masukan kata sandi" name="kata_sandi">
