...
<head>
    ...
    <!-- App css -->
    <link href="<?= base_url() ?>assets/css/bootstrap-modern.min.css" rel="stylesheet" type="text/css" id="bs-default-stylesheet" />
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th class="text-left align-middle">
                        <h2 class="text-dark" style="font-weight:bold">INFORMASI TAGIHAN AIR TANAH</h2>
                    </th>
                </tr>
                <tr>
                    <th class="text-left align-top">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <strong style="font-weight:bold">Pemilik <?= $wajib_pajak['usaha_nama'] ?></strong>
                            </li>
                    ...
                    <th class="text-left align-top">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                ?>
                                <strong style="font-weight:bold"><?=$rowBulan['bulan']?></strong>
                            </li>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <table class="table table-bordered mb-3">
                                <tbody>
                                    <tr>
                                        <td class="text-center align-middle" style="font-weight:bold" width="20%">Volume Range</td>
                                        <td class="text-center" style="font-weight:bold">Volume (m<sup>3</sup>)</td>
                                        <td class="text-center" style="font-weight:bold">FNA</td>
                                        <td class="text-center" style="font-weight:bold">Harga Baku</td>
                                        <td class="text-center" style="font-weight:bold">Jumlah</td>
                                        <td rowspan="9" width="300" class="text-center font-weight-bold align-middle">

                                            <div class="image-container">
                                                <div class="before">
                                                    <h4>Mengetahui, <br> <b>KEPALA DLHK KOTA JAYAPURA</b> </h4>
                                                </div>
                                                <img src="<?=base_url('assets/images/info_tagihan/stempel_ttd.png')?>" alt="">
                                                <div class="after">
                                                    <h4>
