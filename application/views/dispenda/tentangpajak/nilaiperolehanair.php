                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Nilai Perolehan Tanah (NPA)</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Nilai Perolehan Tanah (NPA)</span></h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <form action="<?php echo base_url('C_Tentangpajak/prosesubah_info_npa'); ?>" method="POST">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myLargeModalLabel">Sunting Komponen Sumber Daya Alam</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                        </div>
                                                        <div class="modal-body">

                                                            <div class="form-group">
                                                                <textarea name="isi" class="form-control" rows="20" id="editor"> <?php echo $pajak_npa['isi'] ?> </textarea>
                                                            </div>
                                    ...
                                    <h4 class="header-title">Komponen Sumber Daya Alam</h4>
                                    <p class="sub-header"></p>

                                </div>
                                <div class="col-md-12">

                                    <?php echo $pajak_npa['isi'] ?>
