                            ...
                            <div class="col-md-12">
                                <div class="card-box">
                                    <div class="float-right">
                                        ...
                                        <!-- <a href="<?= base_url() ?>admin/wajibpajak/" class="btn btn-lg btn-light bg-light text-dark"><i class="fas fa-times-circle"></i> kembali</a> -->
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item bg-soft-success"><i class="mdi mdi-book mr-1"></i>
                                            ...
                                            <div class="float-right">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#bs-example-modal-lg" class="btn btn-sm btn-light"><i class="mdi mdi-pencil"></i></a>
                                            </div>
                                        ...
                                        <li class="list-group-item bg-soft-success"><i class="mdi mdi-book mr-1"></i>
                                            Februari
                                            <div class="float-right">
                                                <a href="#" class="btn btn-sm btn-success" title="Cetak Tagihan"><i class="mdi mdi-eye"></i> Tagihan</a>
                                                <a href="#" class="btn btn-sm btn-light"><i class="mdi mdi-pencil"></i></a>
                                            </div>
                                        </li>
                                        <li class="list-group-item bg-soft-warning"><i class="mdi mdi-book mr-1"></i>
                                            Maret
                                            <div class="float-right bg-soft-warning">
                                                <a href="#" class="btn btn-sm btn-warning" title="Terbitkan Bukti Pembayaran"><i class="mdi mdi-send"></i> Terbitkan</a>
                                                <a href="#" class="btn btn-sm btn-light"><i class="mdi mdi-pencil"></i></a>
                                            </div>
                                        </li>
                                    ...
                                    <?php foreach ($wp as $w) { ?>
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item bg-dark">
                                                <h1 class="m-0 font-weight-bold text-white"><?php echo $w->nama_usaha ?></h1>
                                            </li>

                                            <li class="list-group-item text-center">
                                                <img src="<?= base_url() ?>assets/images/gambar_wp/<?php echo $w->foto ?>" alt="contact-img" title="contact-img" class="img-thumbnail" width="200px" />
                                            </li>

                                            <li class="list-group-item">
                                                <label>Nama Pemilik : </label>
                                                <strong><?php echo $w->nama_pemilik ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Kategori Usaha : </label>
                                                <strong><?php echo $w->kategori_usaha ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Luas Bangunan : </label>
                                                <strong><?php echo $w->luas_bangunan ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Luas Lahan : </label>
                                                <strong><?php echo $w->nama_usaha ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Izin Mendirikan Bangunan (IMB) : </label>
                                                <strong><?php echo $w->izin ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Dokumen Lingungan : </label>
                                                <strong><?php echo $w->dokumen ?></strong>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="list-group mt-2">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <strong><?php echo $w->jumlah_kamar ?></strong>
                                            </li>

                                            <li class="list-group-item">
                                                <label>Jumlah Penghuni : </label>
                                                <strong><?php echo $w->jumlah_penghuni ?></strong>
                                            </li>
                                        ...
                                        <ul class="list-group mt-2">
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <strong><?php echo $w->jumlah_kursi ?></strong>
                                            </li>
